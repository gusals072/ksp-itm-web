    ...
    <div className="p-3 md:p-6 w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
        ...
        <div className="lg:col-span-2 space-y-4 md:space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 md:p-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-3 md:mb-4 gap-3">
              <div className="flex items-center space-x-2 md:space-x-3 flex-1 min-w-0">
               ...
               {issue.assigneeId && (
                 <div className="px-2 md:px-4 py-1 md:py-2 bg-blue-50 text-blue-700 rounded-lg text-xs md:text-sm font-medium whitespace-nowrap">
          ...
          {/* 설명 */}
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 md:p-6">
            <h3 className="text-base md:text-lg font-semibold text-gray-800 mb-3 md:mb-4">설명</h3>
